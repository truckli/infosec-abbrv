...
* CEDS：能源输送系统网络安全计划（Cybersecurity for Energy Delivery Systems）
...
* CSET：CISA网络安全评估工具（Cyber Security Evaluation Tool）
...
* CT：证书透明度（Certificate Transparency）
...
* IRS：入侵响应系统（Intrusion Response Systems）
